...
console.log("Bienvenido a la Calculadora de Idemnizacion " + nombre)

let empleador = prompt ("Ingrese el nombre de su Empresa/Empleador: ")

console.log("Asi que tu empresa es: ", empleador)

const importeagregado = 1.21

function calcularindemnizacion (sueldo, años, importeagregado) {
    let sueldobase = (parseInt(sueldo)*importeagregado) // Sueldo multiplicado por valor agregado
    ...
    let pregunta1 = prompt ("Es un caso de fallecimiento del trabajador o del empleador?: Si o No")
        console.log("Es un caso de fallecimiento del trabajador o del empleador?: Si o No")
        console.log(pregunta1)
    if (pregunta1 == "si"){
        sueldox = sueldox * 0.50 // Si es uno de estos casos la idemnizacion seria la mitad.
    } else {
        sueldox
    }
    console.log(nombre + " Tu indemnizacion es de: $ " + sueldox + " con la empresa " + empleador)
